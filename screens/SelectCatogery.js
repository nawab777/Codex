    ...
    <View style={{flex: 1, backgroundColor: '#512F7F'}}>
      ...
      <View style={styles.contentview}>
        <Text style={[styles.textstyle, {marginVertical: 10}]}>
          اپنی نوکری کا انتخاب کریں
        </Text>
        <Text style={{alignSelf: 'center', color: '#8B94A9'}}>
          یہاں اپنی کسی ایک نوکری کا انتخاب کریں۔
        </Text>
        ...
        <ScrollView>
          <View
            ...
            {array.map(index => (
              <Pressable
                onPress={() => {
                  setjobtype(index.jobname);
                  console.log('job type is :', jobtype, index.key);
                }}>
                <View
                  style={[
                    styles.catogerybox,
                    {
                      borderWidth: index.jobname === jobtype ? 2 : 1,
                      borderColor:
                        index.jobname === jobtype ? '#51307E' : '#A3A3A3',
                    },
                  ]}>
                  <View style={styles.jobview}>
                    <RadioButton
                      ...
                      status={
                        jobtype === index.jobname ? 'checked' : 'unchecked'
                      }
